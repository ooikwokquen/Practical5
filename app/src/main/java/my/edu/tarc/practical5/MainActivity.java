package my.edu.tarc.practical5;
...
public class MainActivity extends AppCompatActivity implements AdapterView.OnItemSelectedListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        // Create adapter to link data source to spinner
    ...
    public void CalculatePremium(View view) {
        int position = spinnerAge.getSelectedItemPosition();
        float premium = 0;

        switch(position){
            case 0:
                // TODO: Calculate basic premium
                premium = 50;
                break;
            case 1:
                premium = 55;
